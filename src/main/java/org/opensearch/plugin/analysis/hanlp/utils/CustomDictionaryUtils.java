 ...
 */
package org.opensearch.plugin.analysis.hanlp.utils;
...
/**
 * The custom dictionary utils.
 *
 * @author Rory Ye
 */
public class CustomDictionaryUtils {

    private static final Logger logger = LogManager.getLogger(CustomDictionaryUtils.class);
